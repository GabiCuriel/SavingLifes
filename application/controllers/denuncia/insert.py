...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_denuncia and try to insert new data
        config.model.insert_denuncia(
            form['descripcion_d'],form['calle_d'],form['municipio_d'],form['colonia_d'],form['longitud'],form['latitud'],
        )
